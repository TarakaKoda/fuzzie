...
const GradientSpinningBorder = (props: Props) => {
  return (
    <div className="flex overflow-hidden p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-4 focus:ring-offset-slate-50 !m-0 object-top rounded-full relative transition duration-500 border-1 border dark:border-none">
